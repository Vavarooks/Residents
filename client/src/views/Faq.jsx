                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                ...
                                <p className="Fonts">We have hospice waivers and can accommodate hospice residents.
                                    ...
                                    We use third party service providers for the following: Podiatry, hairdressing, transportation and religious services.
                                    Other services are available upon request.</p>
                            </li>
                            <li className="list-group-item">
